...
const Frame = ({ children }: Props) => {
  ...
  return (
    <div
      id="frame"
      className="select-none w-full h-14 flex flex-row items-center bg-gray-50 dark:bg-gray-800 border border-solid border-gray-200 dark:border-gray-900 p-4 justify-between shadow-sm z-50 transition-colors"
    >
      ...
      <div className="flex flex-row no-drag gap-2 text-gray-600 dark:text-gray-300">
        <ThemeToggle theme={theme} onToggle={handleThemeToggle} />
        <div
          className="hover:bg-gray-200 dark:hover:bg-gray-700 p-1 rounded active:bg-gray-300 dark:active:bg-gray-600 transition-colors cursor-pointer"
